...
<div>
	...
	<div class="about_con">
		...
		<%--<p>--%>
			<%--西安维萨里数字科技有限责任公司。西安维萨里数字科技有限责任公司位于西安市长安区韦曲街办兴龙花园5幢312室--%>
			<%--交通便利。西安维萨里数字科技有限责任公司本着“客户第一，诚信至上”的原则，欢迎国内外企业/公司/机构--%>
			<%--与本单位建立长期的合作关系。热诚欢迎各界朋友前来参观、考察、洽谈业务。西安维萨里数字科技有限责任公司。--%>
			<%--西安维萨里数字科技有限责任公司位于西安市长安区韦曲街办兴龙花园5幢312室交通便利。--%>
			<%--西安维萨里数字科技有限责任公司本着“客户第一，诚信至上”的原则，欢迎国内外企业/公司/机构与本单位--%>
			<%--建立长期的合作关系。热诚欢迎各界朋友前来参观、考察、洽谈业务。--%>
		<%--</p>--%>
		<p>
	...
	<div class="about_img">
		<img style="height: 300px" src="${baseurl}/public/images/erweima.png" alt="" class="vcenter"/>
		<i></i>
	</div>
	<%--底部--%>
